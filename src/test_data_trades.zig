...
test "test_data.trades.dbn" {
    ...
    const file = try std.fs.cwd().openFile("test_data/test_data.trades.dbn", .{});
    defer file.close();
...
test "test_data.trades.v1.dbn.zst" {
    ...
    const file = try std.fs.cwd().openFile("test_data/test_data.trades.v1.dbn.zst", .{});
    defer file.close();
...
test "test_data.trades.v2.dbn.zst" {
    ...
    // Open the compressed test data file
    const file = try std.fs.cwd().openFile("test_data/test_data.trades.v2.dbn.zst", .{});
    defer file.close();
...
test "test_data.trades.v3.dbn.zst" {
    ...
    // Open the compressed test data file
    const file = try std.fs.cwd().openFile("test_data/test_data.trades.v3.dbn.zst", .{});
    defer file.close();
...
test "test_data.trades.dbz" {
    ...
    // Open the compressed test data file
    const file = try std.fs.cwd().openFile("test_data/test_data.trades.dbz", .{});
    defer file.close();
