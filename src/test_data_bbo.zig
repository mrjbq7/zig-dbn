...
test "test_data.bbo-1m.dbn" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1m.dbn");
    defer iter.deinit();
...
test "test_data.bbo-1m.v2.dbn.zst" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1m.v2.dbn.zst");
    defer iter.deinit();
    const meta = iter.meta;
...
test "test_data.bbo-1m.v3.dbn.zst" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1m.v3.dbn.zst");
    defer iter.deinit();
    const meta = iter.meta;
...
test "test_data.bbo-1s.dbn" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1s.dbn");
    defer iter.deinit();
    const meta = iter.meta;
...
test "test_data.bbo-1s.v2.dbn.zst" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1s.v2.dbn.zst");
    defer iter.deinit();
    const meta = iter.meta;
...
test "test_data.bbo-1s.v3.dbn.zst" {
    ...
    var iter = try RecordIterator.init(allocator, "test_data/test_data.bbo-1s.v3.dbn.zst");
    defer iter.deinit();
    const meta = iter.meta;
